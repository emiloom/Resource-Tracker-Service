...
public class ClientServiceUnitTests {
    ...
    void testUpdateOrganizationCoordinates_ValidCoordinates() {
        ...
        when(googlePlacesService.getPlaceCoordinates("Valid Location")).thenReturn(mockCoordinates);
    ...
    void testUpdateOrganizationCoordinates_IncompleteCoordinates() {
        ...
        Client client = new Client();
        client.setLocation("Valid Location");
        when(googlePlacesService.getPlaceCoordinates("Valid Location")).thenReturn(Collections.singletonList(40.7128));
    ...
    void testUpdateOrganizationCoordinates_EmptyCoordinatesFromService() {
        ...
        Client client = new Client();
        client.setLocation("Valid Location");
        when(googlePlacesService.getPlaceCoordinates("Valid Location")).thenReturn(Collections.emptyList());
